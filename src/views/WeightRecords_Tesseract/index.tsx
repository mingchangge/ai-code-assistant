...
// 导入子组件
import ImageUploader from '@/views/WeightRecords/components/ImageUploader'
import RecognitionController from './components/RecognitionController'
import LoadingSpinner from '@/views/WeightRecords/components/LoadingSpinner'
import MetricsTable from '@/views/WeightRecords/components/MetricsTable'
import RawTextDisplay from '@/views/WeightRecords/components/RawTextViewer'
import SaveModal from '@/views/WeightRecords/components/SaveModal'
import HistoryRecords, {
  type HistoryRecordsRef
} from '@/views/WeightRecords/components/HistoryRecords'
import HistoryEcharts from '@/views/WeightRecords/components/HistoryEcharts'
          ...
          <Tabs
            ...
            items={[
              ...
              },
              {
                label: '历史数据分析-普通输出',
                key: '4',
                children: <DataAnalysisNormal records={records} />
              },
              {
                label: '历史数据分析-流式输出',
                key: '5',
